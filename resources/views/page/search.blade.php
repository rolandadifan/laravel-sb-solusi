                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row ">
                                <div class="d-flex">
                                    <div class=""> <h3 class="get-total-search">Total Data Pencarian {{ count($project) }}</h3></div>
                                    <div class="ms-2">
                                        <button class="btn btn-secondary btn-sm" style="margin-top: -8px" onclick="javascript:location.href='{{ route('project.client') }}'"
                                        ><img src="{{ asset('asset/img/refresh.svg') }}" style="width: 20px; " alt=""></button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12" >
                                    <form action="{{ url('/search') }}" method="GET">
                                        <div class="input-group" >
                                         <input id="table_filter" type="text" name="q" placeholder="Find Project" class="form-control search-input" aria-label="Text input with segmented button dropdown" >
